...
<div class="col-12 col-lg-5 rounded-4 bg-black bg-opacity-10 border border-0 pb-5 element-skill" use:scrollAnimation={{ animation: 'zoom-in', duration: 600 }}>
    <div class="row bg-black bg-opacity-25 pt-4 rounded-top-5">
        <div class="col">
            <h3 class="h2 text-center fw-bold second-text" style:color={title_color}>{title}</h3>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col">
            <i class="{icon} fa-5x w-100 text-center" style:color={icon_color} aria-hidden="true"></i>
        </div>
    </div>
</div>
