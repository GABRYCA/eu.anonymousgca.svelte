...
<div class="university-page">
	<div class="container-xxl mt-4 mt-md-5">
		<div class="row justify-content-center">
			<div class="col-12">
				<section
					class="page-hero text-center mb-4 mb-md-5"
					use:scrollAnimation={{ animation: 'fade-up', duration: 350 }}
				>
					<h1 class="university-title page-hero__title mb-3">Simulatore Laurea Università</h1>
					<p class="page-hero__lead mx-auto">
						Calcolatore e simulatore di media ponderata e voto di laurea finale. I dati restano solo sul tuo
						dispositivo.
					</p>
							...
							<div class="row gy-3">
								<div class="col-12 col-md-6">
									<div class="info-section">
										...
										<p class="mb-0 text-light opacity-75">
											Calcoliamo la <strong>media ponderata</strong> secondo il sistema universitario italiano, nello specifico
											quello dell'Università degli Studi dell'Insubria.
										</p>
									</div>
								</div>
								<div class="col-12 col-md-6">
									<div class="info-section">
										...
										<p class="mb-0 text-light opacity-75">
											La nostra "lode" vale come un normale <strong>30 </strong>, ma aggiunge
											<strong>0.33 punti bonus</strong>
											al voto finale (ogni singola lode aggiunge 0.33 punti indipendentemente dal peso dell'esame a livello
											di CFU).
										</p>
									</div>
								</div>
								<div class="col-12">
									<div class="info-section">
										...
										<p class="mb-2 text-light opacity-75">Alcuni dettagli (componenti dei calcoli):</p>
				...
				<div class="card border-custom bg-dark bg-opacity-75 h-100">
					...
					<div class="card-body">
						<form onsubmit={addExam}>
							...
							<div class="d-grid">
								<button type="submit" class="btn btn-custom btn-lg" disabled={!isFormValid}>
								...
								<div class="projection-section border-top-0 rounded-0">
									<div class="current-score-card mb-4">
										...
										<div class="score-value current-score">
											{formatScore(currentFinalScore, currentCanBeLode)}<span class="score-max">/110</span>
										</div>
			...
			<div class="row mt-4">
				<div class="col-12" use:scrollAnimation={{ animation: 'fade-up', duration: 350 }}>
					<div class="card border-custom bg-dark bg-opacity-75">
						<div
							class="card-header bg-transparent border-bottom-0 pt-3 d-flex justify-content-between align-items-center"
						>
							<h4 class="mb-0">
								<i class="fas fa-list me-2 text-accent"></i>
								I Tuoi Esami ({exams.length})
							</h4>
							<button class="btn btn-outline-danger btn-sm" onclick={clearAllExams}>
									...
									<tbody>
										{#each exams as exam (exam.id)}
											<tr class="exam-row">
												...
												<td class="text-center">
													<span
														class="grade-badge grade-{exam.grade >= 27
															? 'excellent'
															: exam.grade >= 24
																? 'good'
																: 'passing'}"
												...
												<td class="text-center">
													<button class="btn btn-delete" onclick={() => removeExam(exam.id)} aria-label="Rimuovi esame">
			...
			<div class="col-12">
				<div class="disclaimer-section text-center" use:scrollAnimation={{ animation: 'fade-up', duration: 350 }}>
					<small class="text-muted disclaimer-text">
						...
						I calcoli e le proiezioni mostrate sono puramente indicativi e possono contenere errori. Non si assumono responsabilità
						per eventuali inesattezze o differenze rispetto ai calcoli ufficiali dell'ateneo. Nessun genere di informazione
						sui dati inseriti viene salvata o condivisa, lo strumento funziona totalmente sul dispositivo dell'utente finale.
					</small>
				</div>
			</div>
		</div>
