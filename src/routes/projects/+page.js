...
export const load = async ({}) => {
	...
	const projects = [
		{
			...
			description:
				"MZEYFILMS's cinematic portfolio website — photography and video work, content managed with PocketBase.",
		...
		},
		{
			...
			description:
				'Theme-aware tooltip action for Svelte 5 with automatic light/dark themes and mobile-friendly behavior. Published on npm and used by this site.',
		...
		},
		{
			...
			description:
				'SvelteKit image compressor and converter to WebP built on Sharp, with a minimal API and token authentication.',
		...
		},
		{
			...
			description:
				'Android application classifying melanoma stages with the TNM system. Mobile programming exam project, built with Kotlin and Jetpack Compose.',
		...
		},
		{
			...
			description:
				'Machine learning study classifying stress and rest from wearable sensor data: EDA, logistic regression, SVM and random forests.',
		...
		},
		{
			...
			description:
				'LaTeX lecture notes and compiled PDFs for Interazione Uomo-Macchina, University of Insubria 2025/26.',
			tags: ['LaTeX', 'PDF', 'HCI']
		},
		{
			kind: 'uni',
		...
		},
		{
			...
			description:
				'Visual Studio Code extension adding complete language support for Baan C and Infor LN (3GL and 4GL).',
	...
	return {
		...
		description:
			'Projects of AnonymousGCA: live websites, Svelte packages and components, university projects and VS Code tooling.',
		keywords:
			'projects, anonymousgca, svelte, sveltekit, university, projects, vs code, extension, npm, websites, open source'
	};
};
