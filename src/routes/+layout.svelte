...
<div style="overflow-x: hidden">
    <div class="container-fluid px-0">
        <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-black px-2 px-md-0 mt-1 mx-1 bg-opacity-50 rounded-5"
                ...
                <div class="row justify-content-evenly text-center text-md-start">
                    ...
                    <div class="col-lg-3 col-md-6 mb-md-0">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li>
                                <a href="https://github.com/GABRYCA" target="_blank" class="text-light"
                                   data-bs-toggle="tooltip" data-bs-placement="right" title="Open">Github</a>
                            </li>
                            <li>
                                <a href="https://discord.gg/RSp2CSuMny" target="_blank" class="text-light"
                            ...
                            <li>
                                <a href="https://www.linkedin.com/in/gabriele-caretti-046408270/" target="_blank"
                                   class="text-light" data-bs-toggle="tooltip" data-bs-placement="right" title="Open">Linkedin</a>
                            </li>
                        </ul>
                    </div>
                </div>
