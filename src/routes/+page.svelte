	...
	<section class="home-hero row justify-content-center align-items-center pb-5 pb-md-0" aria-labelledby="home-title">
		<div class="col-12 col-lg-5 portrait-col" use:scrollAnimation={{ animation: 'ink-up', duration: 900 }}>
			<figure class="portrait-plate">
				<img
					src={favicon}
					alt="Illustrated portrait of AnonymousGCA"
					width="460"
					height="460"
					fetchpriority="high"
					decoding="async"
		...
		<div class="container">
			...
			>
				...
				<CircularLink
					...
					title="Open Linkedin"
				/>
				<CircularLink link="mailto:anonymousgca@anonymousgca.eu" icon="fas fa-envelope" title="Send Email" />
			</div>
		</div>
	</section>
		...
		<div class="container">
			...
			>
				...
				<CircularLink
					...
					title="Open Youtube"
				/>
				<CircularLink link="https://ud.me/anonymousgca.crypto" icon="fas fa-globe" title="Open UD - Crypto - Web3" />
				<CircularLink link="https://www.reddit.com/u/AnonymousGCA" icon="fab fa-reddit" title="Open Reddit" />
			</div>
		</div>
	</section>
</div>
