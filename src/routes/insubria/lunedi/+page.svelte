...
<div class="row text-center rounded-5 border border-light-subtle pt-5 pb-5 mx-1 mb-4 shadow">
    <div class="col text-white">
        ...
        <div class="row justify-content-center">
            <div class="col-auto">
                <h2 class="shadow px-5 pt-1 pb-1 rounded bg-primary bg-opacity-10">Anticipatario Andata <span
                        class="text-danger-emphasis fw-bold">(NO)</span>:</h2>
            </div>
        </div>
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-auto">
                <h2 class="shadow px-5 pt-1 pb-1 rounded bg-primary bg-opacity-10">Anticipatario Ritorno <span
                        class="text-danger-emphasis fw-bold">(NO)</span>:</h2>
            </div>
        </div>
